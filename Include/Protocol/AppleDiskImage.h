...
typedef
EFI_STATUS
(EFIAPI *APPLE_DISK_IMAGE_IS_VALID) (
...
typedef
EFI_STATUS
(EFIAPI *APPLE_DISK_IMAGE_UNMOUNT) (
...
typedef struct {
  UINT32                     Revision;
  APPLE_DISK_IMAGE_IS_VALID  IsValid;
  APPLE_DISK_IMAGE_MOUNT     Mount;
  APPLE_DISK_IMAGE_UNMOUNT   Unmount;
